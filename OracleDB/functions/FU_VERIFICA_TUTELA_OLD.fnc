CREATE OR REPLACE FUNCTION VENCD.FU_VERIFICA_TUTELA_OLD(P_ID_CLIENTE_COMM VI_CD_CLIENTE.ID_CLIENTE%TYPE, P_ID_SOGGETTO_DI_PIANO CD_SOGGETTO_DI_PIANO.ID_SOGGETTO_DI_PIANO%TYPE, P_ID_MATERIALE_DI_PIANO CD_MATERIALE_DI_PIANO.ID_MATERIALE_DI_PIANO%TYPE) RETURN CHAR IS
/******************************************************************************
